...
/** This class is the main server class, which gets run to start the rmi server.  I've set this
* up so that it only allows connections from localhost (127.0.0.1).  This is a security measure.
*/
